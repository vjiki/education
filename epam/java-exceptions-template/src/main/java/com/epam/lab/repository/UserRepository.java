...
import com.epam.lab.service.AuthenticationService;
import com.epam.lab.service.CurrentUserManager;
...
public class UserRepository implements IUserRepository {
     ...
     * {@link AuthenticationService#login(User)}), то будет выброшено исключение.
     */
    @Override
    public void deleteByLogin(String login) throws UnsupportedOperationException {
