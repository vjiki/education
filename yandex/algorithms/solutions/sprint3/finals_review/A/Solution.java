...
Дополнительную пространственную сложность O(1). Мы выделяем память только на две переменные-указетеля и на один
указатель на середину отрезка на каждом шаге цикла.
*/
